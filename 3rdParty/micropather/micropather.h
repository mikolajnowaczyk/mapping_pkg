	...
	*/
	class PathNode
	{
	  public:
        ...
        size_t numAdjacent;		// -1  is unknown & needs to be queried
	...
	private:
        ...
        long unsigned int Hash( void* voidval );
	...
	*/
	class MicroPather
	{
	  ...
	  public:
		...
		*/
		int SolveForNearStates( void* startState, std::vector<StateCost> * near2, float maxCost );
